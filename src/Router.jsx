...
export default function Router() {
  ...
  return useRoutes([
    ...
    { path: "/traveller/:id", element: currentRole === "Traveller" ? (<Traveller />) : (<Navigate to="/" /> )},
    { path: "/traveller/destination/:id", element: currentRole === "Traveller" ? (<SpecificDestination />) : (<Navigate to="/" /> )},
    { path: "/category/destination/:id", element: <SpecificDestination />},
    { path: "/traveller/automatedPlanner", element:currentRole === "Traveller" ? (<AutomatedPlanner />) : (<Navigate to="/" /> )  },
    { path: "/traveller/customizedPlanner", element: currentRole === "Traveller" ? (<CustomizedPlanner />) : (<Navigate to="/" /> )  },
    { path: "/traveller/myTrips/:id", element:currentRole === "Traveller" ? (<MyTrips />) : (<Navigate to="/" /> )   },

    { path: "/traveller/myTrips/:id/:id", element:currentRole === "Traveller" ? (<TripDisplay /> ) : (<Navigate to="/" /> ) },
    { path: "/traveller/profile", element: currentRole === "Traveller" ? (<TravellerProfile />  ) : (<Navigate to="/" /> )},
    { path: "/traveller/travelPlan", element:currentRole === "Traveller" ? (<TravelPlan /> ) : (<Navigate to="/" /> )  },
    { path: "/traveller/editProfile/:id", element: currentRole === "Traveller" ? (<EditProfile />  ) : (<Navigate to="/" /> )},  
