...
const Category = (props) => {
    ...
    return ( 
      <Grid container component="main" className={classes.root}>
        ...
        <Paper className={classes.mainFeaturedPost} style={{ backgroundImage: `url(${categoryData.coverImage})` }}>
     </Paper> 
  <Grid className={classes.typography}>
      
     <Typography className={classes.styledText}>{categoryData.title}</Typography>
